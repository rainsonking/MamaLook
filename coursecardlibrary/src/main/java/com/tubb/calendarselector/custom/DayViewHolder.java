...
public abstract class DayViewHolder {
    ...
    public abstract void setCurrentMonthDayText(FullDay day,int attendCode, boolean isSelected);

    public abstract void setAttendMonthDayText(FullDay day, int attendCode);
